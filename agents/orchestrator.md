...
1. Route vault context via `MASTER_INDEX.md` → relevant section index → ledger/queue/dashboard. Stop reading once the task is supported (CLAUDE.md principle: Markdown is expensive context).
...
- Confirm no drift was left unresolved between control surfaces (CLAUDE.md principle 7).
...
- [`CLAUDE.md`](../CLAUDE.md) — vault operating contract (Phase 1)
- [`AGENTS.md`](../AGENTS.md) — agent roster and shared contract (Phase 5)
