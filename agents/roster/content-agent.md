...
- `newshowbiz-marketing-operator/03-personas-and-behavior-modes.md` — tone and mode rules
- `newshowbiz-marketing-operator/05-risk-guardrails-and-escalation.md` — what language triggers escalation
