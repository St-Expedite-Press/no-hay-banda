...
- [`docs/10-hermes/AGENTS.md`](../../docs/10-hermes/AGENTS.md)
...
- Updates to `docs/10-hermes/AGENTS.md` roster entries when a role description or trigger changed
...
4. If valid: apply the minimal targeted edit to the agent spec. Update the docs/10-hermes/AGENTS.md roster entry only if the role description, triggers, or compatible agents changed.
