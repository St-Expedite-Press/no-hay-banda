...
| Phase 2 | (all Phase 1 personas, read integrations live) | Read-only integrations and reporting active. |
| Phase 3 | (all Phase 1–2 personas, write tools enabled) | `newshowbiz_publish_x` becomes write-capable with receipts and policy checks. |
