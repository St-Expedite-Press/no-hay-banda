...
Hermes Runtime Profile: newshowbiz
  - AIAgent run loop
  - docs/10-hermes/SOUL.md brand identity
  - docs/10-hermes/AGENTS.md project rules
...
Hermes assembles prompt context from stable layers: `docs/10-hermes/SOUL.md`, optional system message, memory snapshots, user profile snapshots, skills, project context files, timestamp, session ID, and platform hint. For New Showbiz:

- `docs/10-hermes/SOUL.md` should define public brand voice and standing product posture.
- `docs/10-hermes/AGENTS.md` should define repository, operator, and risk rules.
...
2. Create a dedicated Hermes profile with `docs/10-hermes/SOUL.md` and `docs/10-hermes/AGENTS.md`.
