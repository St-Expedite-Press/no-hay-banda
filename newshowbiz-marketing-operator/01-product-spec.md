...
- prompt assembly through `SOUL.md`, `AGENTS.md`, skills, memory, and context files
...
- profile-scoped `SOUL.md` for public voice
- project `AGENTS.md` for builder and operator rules
